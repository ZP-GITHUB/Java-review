...
public class CompilerTest
{
   public static void main(final String[] args) throws IOException, ClassNotFoundException
   {
      ...
      String frameClassName = args.length == 0 ? "com.zp.buttons2.ButtonFrame" : args[0];
      ...
      throws IOException, ClassNotFoundException
   {
      ...
      props.load(Class.forName(superclassName).getResourceAsStream("/com/zp/buttons2/action.properties"));
