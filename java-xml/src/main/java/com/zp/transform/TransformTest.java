...
public class TransformTest
{
   public static void main(String[] args) throws Exception
   {
      ...
      else path = Paths.get("java-xml","src","main","java","com","zp","transform", "makehtml.xsl");
      try (InputStream styleIn = Files.newInputStream(path))
      {
         ...
         try (InputStream docIn = Files.newInputStream(Paths.get("java-xml","src","main","java","com","zp","transform", "employee.dat")))
         {
